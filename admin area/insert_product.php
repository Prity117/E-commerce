...
if(isset($_POST['isert_product'])){
    ...
    or $product_brands=='' or $product_price=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
        ...
        product_keywords, category_id, brand_id, product_image1,product_image2, product_image3,product_price, date,status) 
        values('$product_title', '$description', '$product_keywords','$product_category', '$product_brands', '$product_image1', '$product_image2', 
    ...
    <form action="" method="post" enctype="multipart/form-data">
     ...
     <!-- brands -->
       ...
       <div class="form-outline md-4 w-50 m-auto">
        ...
        <!-- price -->
        <div class="form-outline mb-4 w-50 m-auto">
               <input type="submit" name="isert_product" class="btn btn-dark mb-3 px-3" value="Insert Products">
