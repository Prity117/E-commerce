...
<body>
        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                ...
                <div class="button text-center">
                    ...
                    bg-dark my-1">View Products</a></button>
                    <button><a href="index.php?insert_category" class="nav-link text-light 
                    bg-dark my-1">Insert Categories</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">View Categories</a></button>
                    <button><a href="index.php?insert_brand" class="nav-link text-light 
                    bg-dark my-1">Insert Brands</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">View Brands</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">All Orders</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">All Payments</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">List Users</a></button>
                    <button><a href="" class="nav-link text-light 
                    bg-dark my-1">Logout</a></button>
                </div>
            </div>
        </div>
  ...
  <p> Designed by Unplugged BICE-2021</p>
</div>
