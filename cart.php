...
<head>
    ...
    <title>Ecommerce website-Cart details
        ...
        <table class="table table-bordered text-center">
          ...
          ?>
            ...
            <tr>
                ...
                <td><input type="checkbox" name="removeitem[]" value="<?php echo $product_id ?>"></td></td>
                <td>
                  <!--  <button class="bg-secondary text-light border-0 px-3 py-2 mx-3">Update</button> -->
                    <input type="Submit" value="Update Cart" class="bg-secondary text-light border-0 px-3 py-2 mx-3" name="update_cart">
                   <!-- <button class="bg-secondary text-light border-0 px-3 py-2 mx-3">Remove</button> -->
                   <input type="submit" value="Remove" class="bg-secondary text-light border-0 px-3 py-2 mx-3" name="remove_cart">
